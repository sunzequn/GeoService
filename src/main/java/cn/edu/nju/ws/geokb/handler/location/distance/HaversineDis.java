package cn.edu.nju.ws.geokb.handler.location.distance;

import cn.edu.nju.ws.geokb.handler.location.constant.Earth;
...
public class HaversineDis {
    ...
    public static double distance(double lat1, double lon1, double lat2, double lon2) {
        ...
        lon1 = DegreeUtil.deg2rad(lon1);
        lon2 = DegreeUtil.deg2rad(lon2);
